...
(function (root) {
  ...
  const MESSAGES = {
    ja: {
      ...
      "panel.drop.hint": "JSONファイルをドロップして読み込み",
      ...
      "export.col.no": "番号",
      "export.col.tag": "タグ",
      "export.col.group": "グループ",
      "export.col.css": "CSSセレクタ",
      "export.col.xpath": "XPath",
      "export.col.text": "テキスト",
      "export.col.note": "メモ",
      "export.testName": "Marker:HELPER でマークした要素",
      "export.itName": "要素が表示されている",
      "export.cypressXpathNote": "XPath を使うには cypress-xpath プラグインが必要です（npm i -D cypress-xpath）",
      "panel.toast.noMarksToExport": "エクスポートするマーカーがありません",
      "panel.toast.exportFailed": "エクスポートに失敗しました",
      "panel.toast.exported.one": "{n}件のマーカーをエクスポートしました",
      "panel.toast.exported.other": "{n}件のマーカーをエクスポートしました",
      "panel.toast.importFailed": "インポートに失敗しました",
      "panel.toast.importedPartial": "{n}件を復元（{skipped}件は対象が見つからず除外）",
      "panel.toast.imported.one": "{n}件のマーカーを復元しました",
      "panel.toast.imported.other": "{n}件のマーカーを復元しました",
      "panel.toast.readFailedJson": "読み込みに失敗しました（JSON形式エラー）",
      "panel.toast.notMarksFile": "マーカー一覧のファイルではありません",
      "panel.toast.fileTooLarge": "ファイルが大きすぎます",
      "panel.toast.fileReadFailed": "ファイルの読み込みに失敗しました",
      "panel.error.imageLoad": "画像の読み込みに失敗しました",
      "panel.error.pngEncode": "PNGの生成に失敗しました",
      "panel.toast.offscreen": "対象が画面外のため撮影できません",
      "panel.toast.captureFailed": "画像の撮影に失敗しました",
      "panel.toast.imageSaved": "#{n} の画像を保存しました",
      "panel.toast.noMarksToSave": "保存するマーカーがありません",
      "panel.toast.savingImages": "{n}件の画像を保存しています…",
      "panel.toast.savedImagesPartial": "{n}件を保存（{fail}件は失敗/対象なし）",
      "panel.toast.savedImages.one": "{n}件の画像を保存しました",
      "panel.toast.savedImages.other": "{n}件の画像を保存しました",
      "panel.toast.imageCopied": "#{n} の画像をコピーしました",
      "panel.toast.imageCopyFailed": "画像のコピーに失敗しました",
      "report.title": "Marker:HELPER レポート",
      "report.meta.one": "{date} ・ {n}件",
      "report.meta.other": "{date} ・ {n}件",
      "report.print": "印刷 / PDFで保存",
      "report.shotAlt": "#{n} のスクリーンショット",
      "report.noImage": "画像なし",
      "report.dateLocale": "ja-JP",
      "panel.toast.noMarksToReport": "レポートにするマーカーがありません",
      "panel.toast.buildingReport": "{n}件のレポートを作成しています…",
      "panel.toast.reportSaved.one": "{n}件のレポートを保存しました",
      "panel.toast.reportSaved.other": "{n}件のレポートを保存しました",
    },
    en: {
      ...
      "panel.drop.hint": "Drop a JSON file to import",
      ...
      "export.col.no": "No.",
      "export.col.tag": "Tag",
      "export.col.group": "Group",
      "export.col.css": "CSS selector",
      "export.col.xpath": "XPath",
      "export.col.text": "Text",
      "export.col.note": "Note",
      "export.testName": "Elements marked with Marker:HELPER",
      "export.itName": "elements are visible",
      "export.cypressXpathNote": "Using XPath requires the cypress-xpath plugin (npm i -D cypress-xpath)",
      "panel.toast.noMarksToExport": "No markers to export",
      "panel.toast.exportFailed": "Export failed",
      "panel.toast.exported.one": "Exported {n} marker",
      "panel.toast.exported.other": "Exported {n} markers",
      "panel.toast.importFailed": "Import failed",
      "panel.toast.importedPartial": "Restored {n}, skipped {skipped} (target not found)",
      "panel.toast.imported.one": "Restored {n} marker",
      "panel.toast.imported.other": "Restored {n} markers",
      "panel.toast.readFailedJson": "Could not read the file (invalid JSON)",
      "panel.toast.notMarksFile": "This is not a marker list file",
      "panel.toast.fileTooLarge": "The file is too large",
      "panel.toast.fileReadFailed": "Could not read the file",
      "panel.error.imageLoad": "Failed to load the image",
      "panel.error.pngEncode": "Failed to generate the PNG",
      "panel.toast.offscreen": "The target is off-screen and cannot be captured",
      "panel.toast.captureFailed": "Failed to capture the image",
      "panel.toast.imageSaved": "Saved the image of #{n}",
      "panel.toast.noMarksToSave": "No markers to save",
      "panel.toast.savingImages": "Saving {n} images…",
      "panel.toast.savedImagesPartial": "Saved {n}, {fail} failed or missing",
      "panel.toast.savedImages.one": "Saved {n} image",
      "panel.toast.savedImages.other": "Saved {n} images",
      "panel.toast.imageCopied": "Copied the image of #{n}",
      "panel.toast.imageCopyFailed": "Failed to copy the image",
      "report.title": "Marker:HELPER Report",
      "report.meta.one": "{date} · {n} marker",
      "report.meta.other": "{date} · {n} markers",
      "report.print": "Print / Save as PDF",
      "report.shotAlt": "Screenshot of #{n}",
      "report.noImage": "No image",
      "report.dateLocale": "en-US",
      "panel.toast.noMarksToReport": "No markers for the report",
      "panel.toast.buildingReport": "Building a report for {n} markers…",
      "panel.toast.reportSaved.one": "Saved a report with {n} marker",
      "panel.toast.reportSaved.other": "Saved a report with {n} markers",
    },
  };
